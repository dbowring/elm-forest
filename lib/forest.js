...
(function (ForestInternal) {
    ...
    (function (Errors) {
        ...
        Errors[Errors["CommandFailed"] = 19] = "CommandFailed";
        // New Errors
        Errors[Errors["VersionNoExactMatch"] = 20] = "VersionNoExactMatch";
        Errors[Errors["RemovalFailed"] = 21] = "RemovalFailed";
        Errors[Errors["IOError"] = 22] = "IOError";
    ...
    */
    let environSpawn = function (version, cmd, args) {
        return __awaiter(this, void 0, void 0, function* () {
            let binpath = yield getBinPath(version);
    ...
    */
    ForestInternal.runIn = function (version, args) {
        return __awaiter(this, void 0, void 0, function* () {
            return ForestInternal.runCommandIn(version, 'elm', args)
                .catch((err) => {
    ...
    */
    ForestInternal.runCommandIn = function (version, cmd, args) {
        return __awaiter(this, void 0, void 0, function* () {
            yield ForestInternal.ensureInstalled(version, true);
            let child = yield environSpawn(version, cmd, args);
            return new Promise((resolve, reject) => {
                child.stdout.pipe(process.stdout);
                child.stderr.pipe(process.stderr);
                process.stdin.pipe(child.stdin);
                ...
                child.on('close', (code) => {
                    ...
                    if (code === 0) {
                        ...
                        reject(new ForestError(Errors.CommandFailed, `${cmd} command failed with exit code ${code}`, code));
                    }
                });
            });
        });
...
(function (Forest) {
    ...
    Forest.runCommand = ForestInternal.runCommandIn;
