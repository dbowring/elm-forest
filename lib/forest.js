...
(function (ForestInternal) {
    ...
    let parseConstraints = function (constraint) {
        ...
        if (firstMatch && secondMatch) {
            return [
                firstOp[firstMatch[2]](parseVersionString(firstMatch[1])),
                secondOp[secondMatch[1]](parseVersionString(secondMatch[2]))
            ];
        }
        return null;
    };
    ...
    let writeVersionCache = function (versions) {
        ...
        let writeCacheFn = function (resolve, reject) {
            jsonfile.writeFile(versionCache, unpacked, (err, object) => {
                if (err) {
    ...
    */
    ForestInternal.isElmInstalled = function (version) {
        return isdir(ForestInternal.elmRoot(version));
    };
    /* ****************************************************************************
    ...
    */
    ...
    ForestInternal.runNpmCommandIn = function (version, args, pipe) {
        return ForestInternal.ensureInstalled(version)
            .then((_) => {
    ...
    */
    ...
    ForestInternal.ensureInstalled = function (version) {
        return new Promise((resolve, reject) => {
            if (ForestInternal.isElmInstalled(version)) {
                resolve(version);
                return;
            ...
            return ForestInternal.install(version)
                .then((_) => {
...
(function (Forest) {
    ...
    let cliGet = function (args) {
        ...
        Forest.getVersionList()
            ...
            return Forest.install(version, true)
                .then(() => {
